import{fT as Ie,gm as Be,gn as He,gl as Ge,gh as Ve,go as We,gp as Ke,gq as Xe,gr as Ye,gs as qe,gj as ze,gt as Je,d as T,F as y,eY as Ze,B as O,T as E,gu as Qe,r as k,u as P,j as t,W as oe,cI as Ue,es as J,fV as U,e7 as H,aM as Oe,gv as ie,fU as A,fC as L,gw as N,gx as es,gy as $e,g5 as q,bH as ce,bi as R,U as he,M as F,ek as ss,gz as ge,N as ts,O as ns,J as is,gA as os,gB as rs,gC as as}from"./strapi-DJtumbce.js";import{g as re}from"./groupBy-BkEwF48Z.js";var ls=Be,cs=He,ds=Ge,ps=Ve,us=We,hs=ze,gs=Ke,ms=Xe,fs=Ye,xs=qe;function Cs(e,s,i){var n=hs(e),r=n||gs(e)||xs(e);if(s=ps(s),i==null){var a=e&&e.constructor;r?i=n?new a:[]:fs(e)?i=ms(a)?cs(us(e)):{}:i={}}return(r?ls:ds)(e,function(c,o,l){return s(i,c,o,l)}),i}var bs=Cs;const js=Ie(bs),[ys,ks]=Je("PermissionsDataManager"),Y=()=>ks("usePermissionsDataManager");function me(e,s){function i(n,r){return js(n,(a,c,o)=>(ss(c,r[o])||(a[o]=ge(c)&&ge(r[o])?i(c,r[o]):c),a))}return i(e,s)}const Te=e=>Array.isArray(e)?e.reduce((s,i)=>(Array.isArray(i)?s.push(...Te(i)):s.push(i),s),[]):[],G=e=>N(e)?Te(Object.values(e).map(s=>N(s)?G(s):s)):[],ve=(e,s,i)=>e.find(n=>n.action===s&&n.subject===i),As=e=>{const s=fe(e.plugins),i=fe(e.settings),n=xe(e.collectionTypes),r=xe(e.singleTypes);return[...s,...i,...n,...r]},fe=e=>Object.values(e).reduce((s,i)=>{const n=Object.values(i).reduce((r,a)=>{const c=Object.entries(a).reduce((o,[l,{conditions:d,properties:{enabled:p}}])=>(p&&o.push({action:l,subject:null,conditions:ae(d),properties:{}}),o),[]);return[...r,...c]},[]);return[...s,...n]},[]),xe=e=>Object.entries(e).reduce((i,n)=>{const[r,a]=n,c=Object.entries(a).reduce((o,l)=>{const[d,p]=l;if(!G(p).some(h=>h))return o;if(!p?.properties?.enabled){const h=Object.entries(p.properties).reduce((C,f)=>{const[u,m]=f;return C.properties[u]=Me(m),C},{action:d,subject:r,conditions:ae(p.conditions),properties:{}});return[...o,h]}return p.properties.enabled&&o.push({action:d,subject:r,properties:{},conditions:ae(p.conditions)}),o},[]);return[...i,...c]},[]),Me=(e,s="")=>Object.entries(e).reduce((i,n)=>{const[r,a]=n;return N(a)?[...i,...Me(a,`${s}${r}.`)]:(a&&!N(a)&&i.push(`${s}${r}`),i)},[]),ae=e=>Object.entries(e).filter(([,s])=>s).map(([s])=>s),we=(e,s=[])=>e.reduce((i,n)=>(i[n.id]=s.indexOf(n.id)!==-1,i),{}),Ce=(e,s,i=[])=>e.reduce((n,{categoryId:r,childrenForm:a})=>{const c=a.reduce((o,l)=>(o[l.subCategoryId]=l.actions.reduce((d,p)=>{const g=ve(i,p.action,null);return d[p.action]={properties:{enabled:g!==void 0},conditions:we(s,g?.conditions??[])},d},{}),o),{});return n[r]=c,n},{}),Ss=(e,s,i)=>{const n=({children:r=[]},a,c="")=>r.reduce((o,l)=>{if(l.children)return{...o,[l.value]:n(l,a,`${c}${l.value}.`)};const d=a.indexOf(`${c}${l.value}`)!==-1;return o[l.value]=d,o},{});return e.reduce((r,a)=>{const c=s.properties.find(({value:o})=>o===a);if(c){const o=i?.properties[c.value]??[],l=n(c,o);r.properties[a]=l}return r},{properties:{}})},be=({subjects:e,actions:s=[]},i,n=[])=>s.reduce((r,a)=>{const c=a.subjects.reduce((l,d)=>{const p=e.find(({uid:g})=>g===d)||null;return p&&(l[d]=p),l},{});if(J(c))return r;const o=Object.keys(c).reduce((l,d)=>{const{actionId:p,applyToProperties:g}=a,f=c[d].properties.map(({value:x})=>x).every(x=>(g||[]).indexOf(x)===-1),u=ve(n,p,d),m=we(i,u?.conditions??[]);if(l[d]||(l[d]={}),J(g)||f)return l[d][p]={properties:{enabled:u!==void 0},conditions:m},l;const b=Ss(g,c[d],u);return l[d][p]={...b,conditions:m},l},{});return es(r,o)},{}),je=(e,s)=>Object.entries(re(e,s)).map(([i,n])=>({category:i,categoryId:i.split(" ").join("-"),childrenForm:Object.entries(re(n,"subCategory")).map(([r,a])=>({subCategoryName:r,subCategoryId:r.split(" ").join("-"),actions:a}))})),Q=e=>Object.keys(e).reduce((s,i)=>{const n=e[i];if(N(n)&&!U(n,"conditions"))return{...s,[i]:Q(n)};if(N(n)&&U(n,"conditions")&&!G($e(n,"conditions")).some(a=>a)){const a=Object.keys(n.conditions).reduce((c,o)=>(c[o]=!1,c),{});return{...s,[i]:{...n,conditions:a}}}return s[i]=n,s},{}),z=(e,s,i=!1)=>Object.keys(e).reduce((n,r)=>{const a=e[r];return r==="conditions"&&!i?(n[r]=a,n):N(a)?{...n,[r]:z(a,s,r==="fields")}:(n[r]=s,n)},{}),D="12rem",de="20rem",se="5.3rem",pe=e=>e?Object.entries(e).reduce((s,[i,n])=>(i!=="conditions"&&(s[i]=n),s),{}):null,V=e=>{const s=pe(e),i=G(s);if(!i.length)return{hasAllActionsSelected:!1,hasSomeActionsSelected:!1};const n=i.every(a=>a),r=i.some(a=>a)&&!n;return{hasAllActionsSelected:n,hasSomeActionsSelected:r}},Pe=T(y)`
...
`,Ls=({headers:e=[],label:s})=>{const{formatMessage:i}=P();return t.jsxs(y,{children:[t.jsx(y,{width:de,height:se,shrink:0,alignItems:"center",paddingLeft:6,children:t.jsx(E,{variant:"sigma",textColor:"neutral500",children:i({id:"Settings.roles.form.permission.property-label",defaultMessage:"{label} permissions"},{label:s})})}),e.map(n=>n.isActionRelatedToCurrentProperty?t.jsx(y,{width:D,shrink:0,justifyContent:"center",children:t.jsx(E,{variant:"sigma",textColor:"neutral500",children:i({id:`Settings.roles.form.permissions.${n.label.toLowerCase()}`,defaultMessage:n.label})})},n.label):t.jsx(y,{width:D,shrink:0},n.label))]})},ee=e=>Qe`
...
`,Ds=k.forwardRef(({onClick:e,className:s,hasConditions:i=!1,variant:n="tertiary"},r)=>{const{formatMessage:a}=P();return t.jsx(Fs,{$hasConditions:i,className:s,children:t.jsx(oe,{variant:n,startIcon:t.jsx(Ue,{}),onClick:e,ref:r,type:"button",children:a({id:"global.settings",defaultMessage:"Settings"})})})}),Fs=T(O)`
