...
export interface ApiCompaniaCompania extends Struct.SingleTypeSchema {
  collectionName: 'companias';
  info: {
    description: '';
    displayName: 'compania';
    pluralName: 'companias';
    singularName: 'compania';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::compania.compania'
    > &
      Schema.Attribute.Private;
    logo: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    Menu: Schema.Attribute.Component<'web.lista-atributo-valor', true>;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    SocialLinks: Schema.Attribute.Component<'web.lista-atributo-valor2', true>;
    textMessage: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    content: Schema.Attribute.Component<'web.content', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    global: Schema.Attribute.Component<'web.global', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiItemItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    features: Schema.Attribute.Component<'web.lista-atributo-valor2', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiLeadLead extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    IdProducto: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::lead.lead'> &
      Schema.Attribute.Private;
    phone: Schema.Attribute.String;
    promocion: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Link_Global: Schema.Attribute.String &
    ...
    Multimedia_Clasica: Schema.Attribute.Component<'web.clasic-card', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    valoresTipologia: Schema.Attribute.Component<'web.descripcion', false>;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::compania.compania': ApiCompaniaCompania;
